...
<iframe src="/pages/common/article_menu.html" frameborder=0></iframe>
	<div class="mylist">
		<div class="newslist">
			...
			<ul class="clearfix">
				...
				<li>
					...
					<span class="ty3"><?=$v['create_time']?></span>
				</li>
...
<iframe src="/pages/common/footer.html" frameborder=0></iframe>
</body>
</html>